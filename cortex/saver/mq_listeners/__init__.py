"""
This package stores all the listener functions that connect to different MQs when running the saver as a service
...
def listener(scheme):
    ...
    By default, a function or callable class is passed host, port and an instance of the Saver class as arguments
